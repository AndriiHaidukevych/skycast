...
const EUROPE_CODES = new Set([
  "GB", "DE", "FR", "IT", "ES", "NL", "PL", "PT", "SE", "NO", "DK", "FI",
  "CH", "AT", "BE", "CZ", "UA", "RO", "HU", "GR", "BG", "HR", "SK", "SI",
  "EE", "LV", "LT", "IE", "LU", "MT", "CY", "IS",
]);
const NA_CODES = new Set(["US", "CA", "MX"]);
const ASIA_CODES = new Set([
  "JP", "CN", "KR", "IN", "TH", "SG", "AE", "SA", "TR", "ID", "MY",
  "PH", "VN", "PK", "BD", "IR", "IQ", "IL", "JO", "KW", "QA", "OM",
  "HK", "TW", "MN", "KZ", "UZ",
]);
